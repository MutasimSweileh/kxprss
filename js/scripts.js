...
$(document).ready(function () {
  ...
  if ($('.ul-mega').length) {
    var subMenu = $('.navbar-collapse .ul-mega ');
    subMenu.parent('li').children('a').append(function () {
      return '<button class="sub-nav-toggler"> <span class="sr-only">Toggle navigation</span> <i class="fal fa-bars"></i></span> </button>';
    });
    var mainNavToggler = $('.navbar-default .navbar-toggle');
    var subNavToggler = $('.navbar-collapse .sub-nav-toggler');
    ...
    subNavToggler.on('click', function () {
      var Self = $(this);
      Self.parent().parent().children('.ul-mega').slideToggle();
      return false;
    });
  }
  /*
    if ($('.drop-menu ul').length) {
          var subMenu = $('.dropdown-toggle .drop-menu ul');
          subMenu.parent('li').children('a').append(function() {
              return '<button class="sub-nav-toggler"> <span class="sr-only">Toggle navigation</span> <i class="fal fa-bars"></i></span> </button>';
          });
          var mainNavToggler = $('.shop-by-department');
          var subNavToggler = $('.dropdown-toggle .sub-nav-toggler');
          mainNavToggler.on('click', function() {
              var Self = $(this);
              var menu = Self.data('target');
              $(menu).slideToggle();
  ...
  */
  ...
  $('.slider-one__carousel').owlCarousel({
    ...
    dots: false,
    autoplay: true,
    smartSpeed: 1000, autoplayTimeout: 5000,
  ...
  $('.owl-carousel-normal').owlCarousel({
    ...
    dots: false,
    autoplay: true,
    smartSpeed: 1000, autoplayTimeout: 4000,
    navText: ['<i class="fa fa-angle-left"></i>', '<i class="fa fa-angle-right"></i>'],
    responsive: {
      0: {
        items: 2
...
$(window).load(function () {
  ...
  $(".cli-sear").click(function () {
    $(".search_section_wrapper").toggleClass("search-on");
  });
  /*----------------------------------------------------*/
  // flexslider
  /*----------------------------------------------------*/
