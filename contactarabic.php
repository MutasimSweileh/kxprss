        ...
        <div class="wprt-content-box text-white bg-about-1 bg-about">
          <div class="inner">
            ...
            <ul class="styled-icons icon-dark icon-sm icon-circled mb-20">
              <li><a href="<?= getValue("facebook") ?>" data-bg-color="#3B5998" style="background: rgb(59, 89, 152) !important;"><i class="fa fa-facebook"></i></a></li>
              <li><a href="<?= getValue("twitter") ?>" data-bg-color="#02B0E8" style="background: rgb(2, 176, 232) !important;"><i class="fa fa-twitter"></i></a></li>
              <li><a href="https://web.whatsapp.com/send?phone=<?= getValue("whatsapp") ?>" data-bg-color="#D9CCB9" style="background: rgb(98 232 74) !important"><i class="fa fa-whatsapp"></i></a></li>
              <li><a href="<?= getValue("youtube") ?>" data-bg-color="#D71619" style="background: rgb(215, 22, 25) !important;"><i class="fa fa-youtube"></i></a></li>
            </ul>
